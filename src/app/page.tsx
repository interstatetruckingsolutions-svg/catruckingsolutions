          ...
          <div className="mx-auto max-w-6xl px-4 py-14 sm:px-6 sm:py-20 lg:px-8 lg:py-24">
            <div className="flex flex-col items-center gap-10 lg:flex-row lg:items-center lg:gap-16">
              ...
              <div className="min-w-0 flex-1 text-center lg:text-left">
                ...
                <p className="mt-5 text-lg leading-relaxed text-slate-600">
                  ...
                  —all in one place. Get in compliance today with friendly, hassle-free service tailored
            ...
            <ul className="mt-14 grid gap-4 sm:grid-cols-3" role="list">
              ...
              <li className="rounded-xl border border-slate-100 bg-slate-50 px-5 py-4 text-left shadow-sm">
                ...
                <p className="mt-1 text-sm text-slate-600">
                  IRP, IFTA, BOC-3 &amp; liability in one place
                </p>
              </li>
            </ul>
          </div>
        ...
        <section id="why" className="bg-slate-50 py-16 sm:py-20" aria-labelledby="why-heading">
          <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
            ...
            <p className="mt-4 max-w-2xl text-slate-600">
              At CA Trucking Solutions, we speak your language and handle the details—so you can focus
              on miles, not mailrooms.
            </p>
            <div className="mt-12 grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
              ...
              <article className="rounded-2xl border border-slate-200/80 bg-white p-6 shadow-sm">
                ...
                <p className="mt-2 text-sm leading-relaxed text-slate-600">
                  From apportioned plates (IRP) to fuel tax (IFTA) to liability insurance—bundled so you
                  only make one call.
                </p>
              </article>
            </div>
        ...
        <section id="services" className="bg-white py-16 sm:py-20" aria-labelledby="services-heading">
          <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
            ...
            <p className="mt-3 max-w-2xl text-slate-600">
              Our suite keeps your fleet compliant and road-ready.
            </p>
        ...
        <section id="pricing" className="bg-white py-16 sm:py-20" aria-labelledby="pricing-heading">
          <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
            ...
            <p className="mt-4 max-w-3xl text-slate-600">
              Typical costs depend on fleet size, weight, miles, and coverage. Heavier trucks and
              longer hauls usually mean higher IRP fees—we customize to your budget and goals. Sample
              figures are illustrations, not binding quotes.
            </p>
            <div className="mt-12 grid gap-6 lg:grid-cols-3">
              <article className="flex flex-col rounded-2xl border border-slate-200 bg-slate-50/50 p-8">
                ...
                <p className="mt-6 border-t border-slate-200 pt-6 text-sm text-slate-600">
                  <strong className="text-brand-navy">Sample:</strong> ~$400 IRP fees + ~$1,000/yr
                  insurance ($750K liability)—varies widely.
                </p>
              </article>
              <article className="relative flex flex-col rounded-2xl border-2 border-brand-orange bg-white p-8 shadow-lg ring-1 ring-brand-orange/20">
                ...
                <p className="mt-6 border-t border-slate-200 pt-6 text-sm text-slate-600">
                  <strong className="text-brand-navy">Sample:</strong> ~$800 IRP/fees + ~$2,500/yr
                  bundled insurance—illustrative only.
                </p>
              </article>
              <article className="flex flex-col rounded-2xl border border-slate-200 bg-slate-50/50 p-8">
            ...
            <div className="mt-10 grid gap-6 md:grid-cols-2">
              ...
              <blockquote className="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
                ...
                <p className="mt-4 text-base italic leading-relaxed text-brand-navy">
                  “CA Trucking Solutions got me my plates and insurance in two days flat. No
                  headache—just good, friendly service!”
                </p>
              ...
              <article className="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
                ...
                <p className="mt-2 text-sm text-slate-600">
                  Local fleets, owner-operators, and logistics companies use us for ongoing IRP, IFTA,
                  and insurance.
                </p>
              </article>
              <article className="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
        ...
        >
          <div className="mx-auto max-w-2xl px-4">
            ...
            <p className="mt-4 text-slate-300">
              Join California truckers who trust us for on-the-road compliance—without DMV lines or
